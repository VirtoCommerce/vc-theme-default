...
storefrontApp.controller('recentlyCreateNewListDialogController', ['$scope', '$uibModalInstance', 'dialogData', 'listService',
    function ($scope, $uibModalInstance, dialogData, listService) {
